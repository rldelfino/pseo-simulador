...
<body class="antialiased flex flex-col">
    ...
    <script>
        ...
        function calcularTudo() {{
            ...
            document.getElementById('res_cet').innerText = cetReal.toLocaleString('pt-BR', {{minimumFractionDigits:2, maximumFractionDigits:2}}) + '%';
            const rendaSugerida = Math.ceil((p1Trad / 0.30) / 50) * 50;
            document.getElementById('res_renda').innerText = rendaSugerida.toLocaleString('pt-BR', cfg);
